...
@SequenceGenerator (name="cliente", sequenceName="SQ_T_CLIENTE")
public class Cliente {
	...
	public Cliente(String nome, Calendar dataNascimento, String cpf, Genero genero, byte[] foto, boolean status) {
		super();
		this.nome = nome;
		this.dataNascimento = dataNascimento;
		this.cpf = cpf;
